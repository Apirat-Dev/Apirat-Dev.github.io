function init() { 
  ...
  elements.dog.dog.addEventListener('click', (e) => {
  e.stopPropagation(); // prevent triggering moveDog
  Swal.fire({
    title: 'โอ้ยยย!! 🐾',
    html: '<span>จิ้มกูทำเหี้ยอะไร! เขาให้มึงจิ้มปุ่ม Random โว้ยยย!!</span>',
    icon: 'warning',
    confirmButtonText: 'กูขอโทษษษ 😭',
  });
});
